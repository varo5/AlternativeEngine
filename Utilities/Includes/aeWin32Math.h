...
{
	/*************************************************************************************************/
	/* @struct	aePlatformMath
	/*
	/* @brief	Generic platform mathematics.
	/*************************************************************************************************/

	struct AE_UTILITY_EXPORT aeWin32Math
	{
	public:
		/*************************************************************************************************/
		...
		{
			return (T)Floor(((float)Value) + 0.5f);
		}

		template <typename T>
		static inline T Ceil(const T& Value)
		{
			return (T)ceilf((float)Value);
		}
		...
		template <class T>
		static inline float Deg2Rad(const T& Value)
		{
			return DEG_2_RAD * (float)Value;
		}

		template <class T>
		static inline float Rad2Deg(const T& Value)
		{
			return RAD_2_DEG * (float)Value;
		}
